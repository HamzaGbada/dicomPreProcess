...
@app.post(
    ...
    description="Apply the Frequency Edge Detector Based Segmentation (FEDBS) filter to a DICOM image for micro-calcification detection. For more: https://www.semanticscholar.org/paper/Mammograms-calcifications-segmentation-based-on-and/aa9eb94e808a7830635b940d6b566f1e2f965708",
    responses={
        200: {
